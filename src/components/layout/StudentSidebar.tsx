    ...
    const navigation = [
        ...
        },
        {
            ...
            items: [
                ...
                { title: 'Seat Details', path: '/student/seat-view', icon: MapPin },
            ]
        },
        {
            title: 'Attendance',
            items: [
                { title: 'Attendance Status', path: '/student/attendance', icon: ClipboardCheck },
            ]
        },
        {
            title: 'Profile',
                                        ...
                                        <NavLink
                                            ...
                                            className={({ isActive }) =>
                                                `flex items-center px-4 py-2.5 text-sm font-medium rounded-xl transition-colors ${isActive
                                                    ? 'bg-panel-student/10 text-panel-student'
